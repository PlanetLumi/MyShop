...
public class Product implements Comparable<Product> // was Serializable
{
  private static final long serialVersionUID = 20092506; // can delete line
...
@Override
public int compareTo(Product p1) {  // to order by num
	//
